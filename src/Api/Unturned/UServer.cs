...
namespace Essentials.Api.Unturned
{
    ...
    public class UServer
    {
        ...
        //(discord: ellocoed)
        public static void Broadcast(object message, Color color, string Broadcasticon)
        {
            ...
            {
                ChatManager.serverSendMessage(message?.ToString() ?? "null", color, null, null, EChatMode.GLOBAL, Broadcasticon, true);
            }
