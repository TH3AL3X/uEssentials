...
namespace Essentials.Commands
{
    ...
    public class CommandTpAll : EssCommand
    {
        ...
        public override CommandResult OnExecute(ICommandSource src, ICommandArgs args)
        {
            ...
            {
                return CommandResult.LangError("icon_error_general", "NO_PLAYERS_FOR_TELEPORT");
            }
            ...
            switch (args.Length)
            {
                case 0:
                    ...
                    EssLang.Send("generalicon", src, "TELEPORTED_ALL_YOU");
                    break;
                ...
                case 1:
                    ...
                    EssLang.Send("generalicon", src, "TELEPORTED_ALL_PLAYER", player.DisplayName);
                    break;
                ...
                case 3:
                    ...
                    if (!vec3.HasValue)
                    {
                        return CommandResult.LangError("icon_error_general", "INVALID_COORDS", src, args[0], args[1], args[2]);
                    }

                    var pos = vec3.Value;

                    TeleportAll(pos, players);
                    EssLang.Send("generalicon", src, "TELEPORTED_ALL_COORDS", pos.x);
                    break;
